...
def lnlike(theta, data=data):
	...
	lsf, airmass, pwv, A, B, a1_1, a1_0, k1_1, k1_0, p1, a2_1, a2_0, k2_2, k2_1, k2_0, p2  = theta
	...
	chisquare = smart.chisquare(data, model)**2
...
with Pool() as pool:
	...
	sampler = emcee.EnsembleSampler(nwalkers, ndim, lnprob, args=(data,), a=moves, pool=pool, moves=emcee.moves.StretchMove(a=2.0))
	time1 = time.time()
...
lsf_mcmc, airmass_mcmc, pwv_mcmc, A_mcmc, B_mcmc, a1_1_mcmc, a1_0_mcmc, k1_1_mcmc, k1_0_mcmc, p1_mcmc, a2_1_mcmc, a2_0_mcmc, k2_2_mcmc, k2_1_mcmc, k2_0_mcmc, p2_mcmc = map(lambda v: (v[1], v[2]-v[1], v[1]-v[0]), 
...
print(lsf_mcmc, airmass_mcmc, pwv_mcmc, A_mcmc, B_mcmc, a1_1_mcmc, a1_0_mcmc, k1_1_mcmc, k1_0_mcmc, p1_mcmc, a2_1_mcmc, a2_0_mcmc, k2_2_mcmc, k2_1_mcmc, k2_0_mcmc, p2_mcmc)
