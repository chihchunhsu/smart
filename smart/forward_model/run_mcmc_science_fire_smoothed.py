...
def lnlike(theta, data, lsf):
	...
	## Parameters MCMC
	teff, logg, rv, am, pwv, A, B, N, lsf = theta #N noise prefactor
...
def lnprior(theta, limits=limits):
	...
	teff, logg, rv, am, pwv, A, B, N, lsf = theta
...
teff_mcmc, logg_mcmc, rv_mcmc, am_mcmc, pwv_mcmc, A_mcmc, B_mcmc, N_mcmc, lsf_mcmc = map(lambda v: (v[1], v[2]-v[1], v[1]-v[0]), 
